...
const Tab = (props) => {
  ...
  return (
    <div className={`tab-container ${props.rootClassName} `}>
      ...
      <svg onClick={()=>{
          setOpen(0)
          props.setTab(UserTab)
      }} viewBox="0 0 1024 1024" className={open===0?"tab-icon-chosen":"tab-icon3"}>
      ...
      onClick={()=>{
          setOpen(1)
          props.setTab(PlusTab)
      }} viewBox="0 0 1024 1024" className={open===1?"tab-icon-middle-chosen":"tab-icon1"}>
      ...
      onClick={()=>{
          setOpen(2)
          props.setTab(EyeTab)
      }} viewBox="0 0 1024 1024" className={open===2?"tab-icon-chosen":"tab-icon3"}>
